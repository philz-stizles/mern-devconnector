...
import { getLoggedInUserProfile, createOrEditProfile } from '../../store/actions/profileActions';

const EditProfile = ({ createOrEditProfile, history, profile: { profile, loading } }) => {
    ...
    const onChange = e => setProfileForm({ 
        ...profileForm, 
    ...
    const onSubmit = e => {
        e.preventDefault();
        createOrEditProfile(profileForm, history, true);
    };
...
export default connect(mapStateToProps, { getLoggedInUserProfile, createOrEditProfile })(withRouter(EditProfile))
